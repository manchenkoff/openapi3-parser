""" AUTO_GENERATED BY build_mime_types.py - DO NOT EDIT """
...
class ContentType(Enum):
    ...
    MODEL_ANY_XML = 'model/*+xml'
    MODEL_STEP_ZIP = 'model/step+zip'
    MODEL_ANY_ZIP = 'model/*+zip'
    ...
    MODEL_ANY_FASTINFOSET = 'model/*+fastinfoset'
    ...
    APPLICATION_ANY_XML = 'application/*+xml'
    ...
    APPLICATION_ANY_CBOR = 'application/*+cbor'
    ...
    APPLICATION_ANY_JWT = 'application/*+jwt'
    ...
    APPLICATION_ANY_ZIP = 'application/*+zip'
    ...
    APPLICATION_ANY_CBOR_SEQ = 'application/*+cbor-seq'
    ...
    APPLICATION_ANY_DER = 'application/*+der'
    ...
    APPLICATION_ANY_JSON_SEQ = 'application/*+json-seq'
    APPLICATION_GEOPACKAGE_SQLITE3 = 'application/geopackage+sqlite3'
    APPLICATION_ANY_SQLITE3 = 'application/*+sqlite3'
    ...
    APPLICATION_ANY_FASTINFOSET = 'application/*+fastinfoset'
    ...
    APPLICATION_ANY_GZIP = 'application/*+gzip'
    ...
    APPLICATION_ANY_WBXML = 'application/*+wbxml'
    ...
    APPLICATION_ANY_YAML = 'application/*+yaml'
    ...
    APPLICATION_ANY_TLV = 'application/*+tlv'
