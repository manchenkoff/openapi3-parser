...
data_provider = (
    ...
    (
        {"description": "Array with implicit type.", "items": {"type": "string"}},
        AnyOf(
            type=DataType.ANY_OF,
            schemas=[
        ...
        AnyOf(
            ...
            schemas=[
                ...
                Object(
                    type=DataType.OBJECT,
                    properties=[
                        Property("property1", string_schema),
                        Property("property2", number_schema),
                    ],
                    description="Object with implicit type.",
                ),
            ],
...
def test_anyof_builder(data: dict[str, Any], expected: AnyOf) -> None:
