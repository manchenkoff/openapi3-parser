...
from openapi_parser.enumeration import DataType, IntegerFormat
from openapi_parser.specification import Integer
...
def test_integer_builder(data: dict[str, Any], expected: Integer) -> None:
