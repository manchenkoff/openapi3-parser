"""Tests for full OpenAPI 3.1 spec parsing.

Exercises 3.1-specific features: jsonSchemaDialect, webhooks, array type syntax.
"""
...
FIXTURE = os.path.join(os.path.dirname(__file__), "..", "data", "openapi_3.1.yaml")
...
def test_openapi_3_1_full() -> None:
